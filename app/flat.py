...
class option:
  ...
  encoded_street_name = {'ANG MO KIO AVE 1': 1, 'ANG MO KIO AVE 3': 2,
                     ...
                     'BT BATOK EAST AVE 6': 581,
                     'BT BATOK WEST AVE 9': 582,
                     'TAMPINES ST 61': 583,
                     'YISHUN ST 43': 584,
                     'SENGKANG WEST RD': 585,
                     'BIDADARI PK DR': 586,
                     'CANBERRA VIEW': 587,
                     'TAMPINES NTH DR 1': 588}
...
if selected == "Home":
        ...
        # Example usage
            ...
            with st.form("my form 1"): 
                      ...
                      with col1:
                                 st.write (" ")
                                 user_town = st.selectbox(label = "City Name", options = option.option_town, index =None)
                      ...
                      with col3:
                                 st.write (" ")
                                 user_street_name = st.selectbox(label = "Street Name", options = option.option_street_name, index =None)
                                   ...
                                   with st.spinner("Predicting..."):
                                        if not all([user_town,user_flat_type,user_street_name,user_flat_model]):
                                         st.error ("please fill all fields")  
                                          ...
                                          clamped_prediction = min(raw_prediction[0], 1)  # Adjust threshold as needed
